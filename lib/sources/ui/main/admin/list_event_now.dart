...
class ListEventNow extends StatefulWidget {
  const ListEventNow({Key? key}) : super(key: key);

  @override
  _ListEventNow createState() => _ListEventNow();
}

class _ListEventNow extends State<ListEventNow> {
  ...
  void getListEC() async {
    ...
    List<eventContestNow>? _listEC =
        await getListEC.getListECNow(1, formattedDate);
    setState(() {
