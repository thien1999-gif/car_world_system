...
class ViewDetailAccessoryToBought extends StatefulWidget {
  final String responseId, carID;
  final int userID;
  const ViewDetailAccessoryToBought({ Key? key, required this.responseId,required this.carID, required this.userID }) : super(key: key);

  @override
  _ViewDetailAccessoryToBoughtState createState() => _ViewDetailAccessoryToBoughtState(responseId, carID, userID);
}

class _ViewDetailAccessoryToBoughtState extends State<ViewDetailAccessoryToBought> {
  final String responseId, carID;
  final int userID;
...
final ScrollController scrollController_1 = ScrollController();
  ...
  _ViewDetailAccessoryToBoughtState(this.responseId, this.carID, this.userID);
  @override
  void initState() {
    super.initState();

    exchangeBloc.getExchangeAccessoryDetail(carID);
  }
                          ...
                          actions: <Widget>[
                            ...
                            FlatButton(
                                onPressed: () {
                                  ...
                                  eventRepository.sendFeedBackExchangeToBuy(
                                      responseId, feedBack);
