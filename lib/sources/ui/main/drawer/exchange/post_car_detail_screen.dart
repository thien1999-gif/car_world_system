...
class PostCarDetailScreen extends StatefulWidget {
  const PostCarDetailScreen({Key? key}) : super(key: key);

  @override
  _PostCarDetailScreenState createState() => _PostCarDetailScreenState();
}
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (context) => AlertDialog(
                      title: Text('Xác nhận'),
                      content:
                          Text('Bạn có chắc là muốn gỡ bài đăng này không?'),
                      actions: <Widget>[
                        FlatButton(
                            onPressed: () {},
                            child: Text('Không',
