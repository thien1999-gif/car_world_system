...
import 'package:car_world_system/sources/ui/main/drawer/exchange/view_car_detail_to_sell.dart';
import 'package:flutter/material.dart';
import 'package:intl/intl.dart';
import 'package:sizer/sizer.dart';
class ViewExchangeCarToSell extends StatefulWidget {
  const ViewExchangeCarToSell({ Key? key }) : super(key: key);

  @override
  _ViewExchangeCarToSellState createState() => _ViewExchangeCarToSellState();
}

class _ViewExchangeCarToSellState extends State<ViewExchangeCarToSell> {
  ...
  Widget _loadListExchangeCarOfUser() {
    if (_profile == null) {
      ...
      exchangeBloc.getExchangeCarToSell(_profile!.id);
              ...
              return GestureDetector(
                  onTap: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => ViewCarDetailToSell(carId: data[index].id),
                        ));
                  },
                  child: Padding(
